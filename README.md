...
4. Pick a benchmark ([LIBERO](https://libero-project.github.io/), [SimplerEnv](https://github.com/simpler-env/SimplerEnv) ⭐ 1,165 | 🐛 35 | 🌐 Jupyter Notebook | 📅 2025-12-20, [RoboCasa](https://robocasa.ai/)) and reproduce one result before you propose anything.
...
| [ToOptix](https://github.com/DerBaumeister/toOptix) / [ToPy](https://github.com/williamhunter/topy) ⭐ 577 \| 🐛 11 \| 🌐 Python \| 📅 2022-08-31            | Topology optimisation    | 🆓                 | Learn the method before paying for a suite                                 |
...
| [PrusaSlicer](https://www.prusa3d.com/prusaslicer/) / [OrcaSlicer](https://github.com/SoftFever/OrcaSlicer) ⭐ 15,718 \| 🐛 2,682 \| 🌐 C++ \| 📅 2026-09-19 | Slicers                  | 🆓                 | Printed robot parts: print orientation determines layer-direction strength |
...
* 🔧 [Python Robotics](https://github.com/AtsushiSakai/PythonRobotics) ⭐ 30,542 | 🐛 56 | 🌐 Python | 📅 2026-09-14 🆓 — readable implementations of dozens of algorithms. **Excellent for learning.** ⭐
* 🔧 [Pinocchio](https://github.com/stack-of-tasks/pinocchio) ⭐ 3,742 | 🐛 105 | 🌐 C++ | 📅 2026-09-07 🆓 — fast rigid-body dynamics with analytical derivatives. The backbone of most modern whole-body controllers.
* 🔧 [Crocoddyl](https://github.com/loco-3d/crocoddyl) ⭐ 1,305 | 🐛 19 | 🌐 C++ | 📅 2026-09-15 🆓 — DDP-family optimal control for legged/multi-contact robots. 🔬
...
| ------------------------------------------------------------------------------------------------------------------------- | ------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [**Newton**](https://github.com/newton-physics/newton) ⭐ 5,652 \| 🐛 444 \| 🌐 Python \| 📅 2026-09-18                    | 🆓     | The new centre of gravity. Open-source, GPU-accelerated, differentiable; built on NVIDIA Warp + OpenUSD; developed by NVIDIA + Google DeepMind + Disney Research under the Linux Foundation. v1.0 GA at GTC 2026. Bundles MuJoCo-Warp and Disney's Kamino (closed-loop mechanisms) solvers, SDF collision, hydroelastic contact, and deformables. |
| [MuJoCo](https://mujoco.org/)                                                                                             | 🆓     | Contact-rich control research; CPU version remains the easiest to debug                                                                                                                                                                                                                                                                           |
| [MuJoCo Playground](https://github.com/google-deepmind/mujoco_playground) ⭐ 2,218 \| 🐛 112 \| 🌐 Python \| 📅 2026-09-19 | 🆓     | Ready-made GPU RL environments                                                                                                                                                                                                                                                                                                                    |
| [Isaac Lab](https://github.com/isaac-sim/IsaacLab) ⭐ 8,169 \| 🐛 519 \| 🌐 Python \| 📅 2026-09-19                        | 🆓     | Large-scale robot learning; v3.0 builds on Newton + PhysX                                                                                                                                                                                                                                                                                         |
| [Isaac Sim](https://developer.nvidia.com/isaac/sim)                                                                       | 🆓     | Photorealistic digital twins, synthetic data, sensor simulation                                                                                                                                                                                                                                                                                   |
| [Genesis](https://github.com/Genesis-Embodied-AI/Genesis) ⭐ 29,967 \| 🐛 127 \| 🌐 Python \| 📅 2026-09-16                | 🆓     | Fast multi-platform GPU physics; strong on generative scene creation                                                                                                                                                                                                                                                                              |
...
* 🔧 [SAM 2](https://github.com/facebookresearch/sam2) ⭐ 19,896 | 🐛 488 | 🌐 Jupyter Notebook | 📅 2026-05-30 🆓 — promptable segmentation for images and video; now a standard preprocessing block in robot perception.
* 🔧 [ORB-SLAM3](https://github.com/UZ-SLAMLab/ORB_SLAM3) ⭐ 9,084 | 🐛 572 | 🌐 C++ | 📅 2024-07-24 🆓 / [RTAB-Map](https://introlab.github.io/rtabmap/) 🆓 — visual and RGB-D SLAM.
* 🔧 [Nerfstudio](https://docs.nerf.studio/) 🆓 / [gsplat](https://github.com/nerfstudio-project/gsplat) ⭐ 5,700 | 🐛 369 | 🌐 Python | 📅 2026-09-19 🆓 — NeRF and 3D Gaussian splatting; now used for real-to-sim asset capture.
* 🔧 [FoundationPose](https://github.com/NVlabs/FoundationPose) ⭐ 3,572 | 🐛 145 | 🌐 Python | 📅 2026-04-29 🆓 — 6-DoF pose estimation for novel objects.
...
* 📄 [**Diffusion Policy: Visuomotor Policy Learning via Action Diffusion**](https://diffusion-policy.cs.columbia.edu/) — Chi et al., RSS 2023 / *IJRR* 2025. 🆓 **The foundational paper.** ⭐ [code](https://github.com/real-stanford/diffusion_policy) ⭐ 4,568 | 🐛 99 | 🌐 Python | 📅 2024-12-24 · [arXiv](https://arxiv.org/abs/2303.04137)
...
| [**OpenVLA**](https://openvla.github.io/)                                                                                        | 7B      | 🆓            | Stanford/Berkeley, 2024. \~970k Open X-Embodiment episodes; DINOv2 + SigLIP + Llama 2. The reference open VLA. [📄](https://arxiv.org/abs/2406.09246) [code](https://github.com/openvla/openvla) ⭐ 7,044 \| 🐛 117 \| 🌐 Python \| 📅 2025-03-23 |
| [OpenVLA-OFT](https://openvla-oft.github.io/)                                                                                    | 7B      | 🆓            | Optimised fine-tuning recipe; large speed/success gains over base OpenVLA                                                                                                                                                                        |
| [**π₀ / openpi**](https://github.com/Physical-Intelligence/openpi) ⭐ 13,890 \| 🐛 345 \| 🌐 Python \| 📅 2026-08-24              | \~3B    | 🆓 weights    | Physical Intelligence. Flow-matching action expert on a VLM backbone; pretrained on 10,000+ hours. Smoothest trajectories in contact-rich tasks. [📄](https://arxiv.org/abs/2410.24164)                                                          |
| [**Isaac GR00T N**](https://github.com/NVIDIA/Isaac-GR00T) ⭐ 8,088 \| 🐛 332 \| 🌐 Python \| 📅 2026-08-20                       | \~2–3B  | 🆓            | NVIDIA. Dual-system: slow VLM planner (System 2) + fast diffusion transformer controller (System 1). N1 (Mar 2025) → N1.5 → N1.6 (Dec 2025, Cosmos-2B backbone). Built for humanoids. [📄](https://arxiv.org/abs/2503.14734)                     |
...
* 🔧 [rsl\_rl](https://github.com/leggedrobotics/rsl_rl) ⭐ 2,994 | 🐛 5 | 🌐 Python | 📅 2026-09-09 🆓 — the PPO implementation behind most legged-robot papers.
...
| [SimplerEnv](https://github.com/simpler-env/SimplerEnv) ⭐ 1,165 \| 🐛 35 \| 🌐 Jupyter Notebook \| 📅 2025-12-20 🆓 | Reproducible simulated evaluation of real-robot VLAs                            |
...
* 🔧 [**LeRobot**](https://github.com/huggingface/lerobot) ⭐ 27,617 | 🐛 920 | 🌐 Python | 📅 2026-09-19 🆓 — Hugging Face's end-to-end robot learning library. `pip install`, no ROS required. Includes ACT, Diffusion Policy, VQ-BeT, π₀, SmolVLA, HIL-SERL, TD-MPC. ⭐ [📄 ICLR 2026](https://arxiv.org/abs/2602.22818)
...
| ----------------------------------------------------------------------------------------------------------- | --------- | -------------------- | ---------------------------------------------------------------------------------------------------------------------- |
| [SO-101 / SO-ARM101](https://github.com/TheRobotStudio/SO-ARM100) ⭐ 7,516 \| 🐛 86 \| 📅 2026-09-06         | €120–350  | 6-DoF arm pair       | 🆓 open hardware. Leader/follower teleoperation; the LeRobot reference platform. Kits from Hiwonder, Seeed, WowRobo. ⭐ |
| [LeKiwi](https://github.com/SIGRobotics-UIUC/LeKiwi) ⭐ 1,426 \| 🐛 13 \| 📅 2026-08-05                      | €400      | Mobile manipulator   | SO-101 on a holonomic base; open source                                                                                |
...
| [Open Duck Mini](https://github.com/apirrone/Open_Duck_Mini) ⭐ 4,115 \| 🐛 31 \| 🌐 Python \| 📅 2026-01-31 | €400      | Bipedal              | Approachable legged-robot learning platform                                                                            |
...
* [LeRobot](https://github.com/huggingface/lerobot) ⭐ 27,617 | 🐛 920 | 🌐 Python | 📅 2026-09-19 — very active Discord; the current invite is linked from the repo README
...
* [PythonRobotics](https://github.com/AtsushiSakai/PythonRobotics) ⭐ 30,542 | 🐛 56 | 🌐 Python | 📅 2026-09-14 — algorithms with readable code
* [robotics-coursework](https://github.com/mithi/robotics-coursework) ⭐ 5,256 | 🐛 2 | 📅 2026-08-31 — where to learn robotics online
* [Awesome LLM Robotics](https://github.com/GT-RIPL/Awesome-LLM-Robotics) ⭐ 4,467 | 🐛 12 | 📅 2026-07-17
* [Awesome ROS2](https://github.com/fkromer/awesome-ros2) ⚠️ Archived
* [Awesome Robotics](https://github.com/ahundt/awesome-robotics) ⭐ 1,489 | 🐛 8 | 📅 2024-01-10 · [Awesome Robotics Libraries](https://github.com/jslee02/awesome-robotics-libraries) ⭐ 3,049 | 🐛 27 | 🌐 Python | 📅 2026-09-18
* [Awesome Embodied AI](https://github.com/haoranD/Awesome-Embodied-AI) ⭐ 530 | 🐛 5 | 📅 2025-06-03
* [Awesome Physical AI](https://github.com/keon/awesome-physical-ai) ⭐ 422 | 🐛 17 | 📅 2026-06-24 — VLA, world models, embodied AI, robot foundation models
* [Awesome VLA](https://github.com/KwanWaiPang/Awesome-VLA) ⭐ 101 | 🐛 2 | 📅 2026-02-03 — actively maintained VLA paper tracker

**Engineering & embedded**

* [Awesome C++](https://github.com/fffaraz/awesome-cpp) ⭐ 73,356 | 🐛 311 | 📅 2026-09-19 · [Awesome Python](https://github.com/vinta/awesome-python) ⭐ 321,641 | 🐛 26 | 🌐 Python | 📅 2026-09-18
* [Awesome Embedded](https://github.com/nhivp/Awesome-Embedded) ⭐ 9,127 | 🐛 5 | 📅 2026-09-06 · [Awesome Embedded Rust](https://github.com/rust-embedded/awesome-embedded-rust) ⭐ 8,098 | 🐛 16 | 📅 2026-09-11
* [Awesome Electronics](https://github.com/kitspace/awesome-electronics) ⭐ 8,135 | 🐛 36 | 📅 2026-09-14
* [Awesome Embedded and IoT Security](https://github.com/fkie-cad/awesome-embedded-and-iot-security) ⭐ 2,448 | 🐛 2 | 📅 2023-10-17
* [Awesome Mechanical Engineering](https://github.com/m2n037/awesome-mecheng) ⭐ 1,695 | 🐛 22 | 📅 2024-09-24
* [Awesome TinyML](https://github.com/gigwegbe/tinyml-papers-and-projects) ⭐ 1,032 | 🐛 3 | 📅 2025-12-08

**AI**

* [Awesome MCP Servers](https://github.com/modelcontextprotocol/servers) ⭐ 90,458 | 🐛 546 | 🌐 TypeScript | 📅 2026-09-03
* [Awesome Machine Learning](https://github.com/josephmisiti/awesome-machine-learning) ⭐ 74,371 | 🐛 29 | 🌐 Python | 📅 2026-09-17 · [Awesome Deep Learning](https://github.com/ChristosChristofidis/awesome-deep-learning) ⭐ 28,938 | 🐛 87 | 📅 2025-05-26
