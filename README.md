...
4. Pick a benchmark ([LIBERO](https://libero-project.github.io/), [SimplerEnv](https://github.com/simpler-env/SimplerEnv) ⭐ 1,152 | 🐛 33 | 🌐 Jupyter Notebook | 📅 2025-12-20, [RoboCasa](https://robocasa.ai/)) and reproduce one result before you propose anything.
...
| [PrusaSlicer](https://www.prusa3d.com/prusaslicer/) / [OrcaSlicer](https://github.com/SoftFever/OrcaSlicer) ⭐ 15,537 \| 🐛 2,645 \| 🌐 C++ \| 📅 2026-08-31 | Slicers                  | 🆓                 | Printed robot parts: print orientation determines layer-direction strength |
...
* 🔧 [Python Robotics](https://github.com/AtsushiSakai/PythonRobotics) ⭐ 30,418 | 🐛 51 | 🌐 Python | 📅 2026-08-24 🆓 — readable implementations of dozens of algorithms. **Excellent for learning.** ⭐
* 🔧 [Pinocchio](https://github.com/stack-of-tasks/pinocchio) ⭐ 3,694 | 🐛 108 | 🌐 C++ | 📅 2026-08-31 🆓 — fast rigid-body dynamics with analytical derivatives. The backbone of most modern whole-body controllers.
* 🔧 [Crocoddyl](https://github.com/loco-3d/crocoddyl) ⭐ 1,292 | 🐛 20 | 🌐 C++ | 📅 2026-08-26 🆓 — DDP-family optimal control for legged/multi-contact robots. 🔬
...
| ------------------------------------------------------------------------------------------------------------------------- | ------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [**Newton**](https://github.com/newton-physics/newton) ⭐ 5,561 \| 🐛 402 \| 🌐 Python \| 📅 2026-08-31                    | 🆓     | The new centre of gravity. Open-source, GPU-accelerated, differentiable; built on NVIDIA Warp + OpenUSD; developed by NVIDIA + Google DeepMind + Disney Research under the Linux Foundation. v1.0 GA at GTC 2026. Bundles MuJoCo-Warp and Disney's Kamino (closed-loop mechanisms) solvers, SDF collision, hydroelastic contact, and deformables. |
| [MuJoCo](https://mujoco.org/)                                                                                             | 🆓     | Contact-rich control research; CPU version remains the easiest to debug                                                                                                                                                                                                                                                                           |
| [MuJoCo Playground](https://github.com/google-deepmind/mujoco_playground) ⭐ 2,172 \| 🐛 105 \| 🌐 Python \| 📅 2026-08-26 | 🆓     | Ready-made GPU RL environments                                                                                                                                                                                                                                                                                                                    |
| [Isaac Lab](https://github.com/isaac-sim/IsaacLab) ⭐ 8,014 \| 🐛 519 \| 🌐 Python \| 📅 2026-08-31                        | 🆓     | Large-scale robot learning; v3.0 builds on Newton + PhysX                                                                                                                                                                                                                                                                                         |
| [Isaac Sim](https://developer.nvidia.com/isaac/sim)                                                                       | 🆓     | Photorealistic digital twins, synthetic data, sensor simulation                                                                                                                                                                                                                                                                                   |
| [Genesis](https://github.com/Genesis-Embodied-AI/Genesis) ⭐ 29,842 \| 🐛 130 \| 🌐 Python \| 📅 2026-08-29                | 🆓     | Fast multi-platform GPU physics; strong on generative scene creation                                                                                                                                                                                                                                                                              |
...
* 🔧 [SAM 2](https://github.com/facebookresearch/sam2) ⭐ 19,783 | 🐛 482 | 🌐 Jupyter Notebook | 📅 2026-05-30 🆓 — promptable segmentation for images and video; now a standard preprocessing block in robot perception.
* 🔧 [ORB-SLAM3](https://github.com/UZ-SLAMLab/ORB_SLAM3) ⭐ 9,000 | 🐛 571 | 🌐 C++ | 📅 2024-07-24 🆓 / [RTAB-Map](https://introlab.github.io/rtabmap/) 🆓 — visual and RGB-D SLAM.
* 🔧 [Nerfstudio](https://docs.nerf.studio/) 🆓 / [gsplat](https://github.com/nerfstudio-project/gsplat) ⭐ 5,611 | 🐛 361 | 🌐 Python | 📅 2026-08-20 🆓 — NeRF and 3D Gaussian splatting; now used for real-to-sim asset capture.
* 🔧 [FoundationPose](https://github.com/NVlabs/FoundationPose) ⭐ 3,525 | 🐛 144 | 🌐 Python | 📅 2026-04-29 🆓 — 6-DoF pose estimation for novel objects.
...
| [**OpenVLA**](https://openvla.github.io/)                                                                                        | 7B      | 🆓            | Stanford/Berkeley, 2024. \~970k Open X-Embodiment episodes; DINOv2 + SigLIP + Llama 2. The reference open VLA. [📄](https://arxiv.org/abs/2406.09246) [code](https://github.com/openvla/openvla) ⭐ 6,917 \| 🐛 113 \| 🌐 Python \| 📅 2025-03-23 |
| [OpenVLA-OFT](https://openvla-oft.github.io/)                                                                                    | 7B      | 🆓            | Optimised fine-tuning recipe; large speed/success gains over base OpenVLA                                                                                                                                                                        |
| [**π₀ / openpi**](https://github.com/Physical-Intelligence/openpi) ⭐ 13,549 \| 🐛 331 \| 🌐 Python \| 📅 2026-08-24              | \~3B    | 🆓 weights    | Physical Intelligence. Flow-matching action expert on a VLM backbone; pretrained on 10,000+ hours. Smoothest trajectories in contact-rich tasks. [📄](https://arxiv.org/abs/2410.24164)                                                          |
| [**Isaac GR00T N**](https://github.com/NVIDIA/Isaac-GR00T) ⭐ 7,968 \| 🐛 322 \| 🌐 Python \| 📅 2026-08-20                       | \~2–3B  | 🆓            | NVIDIA. Dual-system: slow VLM planner (System 2) + fast diffusion transformer controller (System 1). N1 (Mar 2025) → N1.5 → N1.6 (Dec 2025, Cosmos-2B backbone). Built for humanoids. [📄](https://arxiv.org/abs/2503.14734)                     |
...
* 🔧 [rsl\_rl](https://github.com/leggedrobotics/rsl_rl) ⭐ 2,930 | 🐛 7 | 🌐 Python | 📅 2026-08-31 🆓 — the PPO implementation behind most legged-robot papers.
...
| [SimplerEnv](https://github.com/simpler-env/SimplerEnv) ⭐ 1,152 \| 🐛 33 \| 🌐 Jupyter Notebook \| 📅 2025-12-20 🆓 | Reproducible simulated evaluation of real-robot VLAs                            |
...
* 🔧 [**LeRobot**](https://github.com/huggingface/lerobot) ⭐ 27,108 | 🐛 844 | 🌐 Python | 📅 2026-08-31 🆓 — Hugging Face's end-to-end robot learning library. `pip install`, no ROS required. Includes ACT, Diffusion Policy, VQ-BeT, π₀, SmolVLA, HIL-SERL, TD-MPC. ⭐ [📄 ICLR 2026](https://arxiv.org/abs/2602.22818)
...
| ----------------------------------------------------------------------------------------------------------- | --------- | -------------------- | ---------------------------------------------------------------------------------------------------------------------- |
| [SO-101 / SO-ARM101](https://github.com/TheRobotStudio/SO-ARM100) ⭐ 7,246 \| 🐛 83 \| 📅 2026-08-05         | €120–350  | 6-DoF arm pair       | 🆓 open hardware. Leader/follower teleoperation; the LeRobot reference platform. Kits from Hiwonder, Seeed, WowRobo. ⭐ |
| [LeKiwi](https://github.com/SIGRobotics-UIUC/LeKiwi) ⭐ 1,399 \| 🐛 12 \| 📅 2026-08-05                      | €400      | Mobile manipulator   | SO-101 on a holonomic base; open source                                                                                |
...
| [Open Duck Mini](https://github.com/apirrone/Open_Duck_Mini) ⭐ 3,765 \| 🐛 24 \| 🌐 Python \| 📅 2026-01-31 | €400      | Bipedal              | Approachable legged-robot learning platform                                                                            |
...
* [LeRobot](https://github.com/huggingface/lerobot) ⭐ 27,108 | 🐛 844 | 🌐 Python | 📅 2026-08-31 — very active Discord; the current invite is linked from the repo README
...
* [PythonRobotics](https://github.com/AtsushiSakai/PythonRobotics) ⭐ 30,418 | 🐛 51 | 🌐 Python | 📅 2026-08-24 — algorithms with readable code
* [robotics-coursework](https://github.com/mithi/robotics-coursework) ⭐ 5,186 | 🐛 2 | 📅 2026-08-29 — where to learn robotics online
* [Awesome LLM Robotics](https://github.com/GT-RIPL/Awesome-LLM-Robotics) ⭐ 4,458 | 🐛 10 | 📅 2026-07-17
* [Awesome ROS2](https://github.com/fkromer/awesome-ros2) ⚠️ Archived
* [Awesome Robotics](https://github.com/ahundt/awesome-robotics) ⭐ 1,481 | 🐛 8 | 📅 2024-01-10 · [Awesome Robotics Libraries](https://github.com/jslee02/awesome-robotics-libraries) ⭐ 3,030 | 🐛 17 | 🌐 Python | 📅 2026-08-25
* [Awesome Embodied AI](https://github.com/haoranD/Awesome-Embodied-AI) ⭐ 528 | 🐛 4 | 📅 2025-06-03
* [Awesome Physical AI](https://github.com/keon/awesome-physical-ai) ⭐ 404 | 🐛 16 | 📅 2026-06-24 — VLA, world models, embodied AI, robot foundation models
* [Awesome VLA](https://github.com/KwanWaiPang/Awesome-VLA) ⭐ 96 | 🐛 2 | 📅 2026-02-03 — actively maintained VLA paper tracker

**Engineering & embedded**

* [Awesome C++](https://github.com/fffaraz/awesome-cpp) ⭐ 73,056 | 🐛 310 | 📅 2026-08-22 · [Awesome Python](https://github.com/vinta/awesome-python) ⭐ 317,297 | 🐛 18 | 🌐 Python | 📅 2026-08-25
* [Awesome Embedded](https://github.com/nhivp/Awesome-Embedded) ⭐ 9,062 | 🐛 8 | 📅 2026-08-12 · [Awesome Embedded Rust](https://github.com/rust-embedded/awesome-embedded-rust) ⭐ 8,056 | 🐛 14 | 📅 2026-08-28
...
* [Awesome Mechanical Engineering](https://github.com/m2n037/awesome-mecheng) ⭐ 1,675 | 🐛 22 | 📅 2024-09-24
* [Awesome TinyML](https://github.com/gigwegbe/tinyml-papers-and-projects) ⭐ 1,032 | 🐛 3 | 📅 2025-12-08

**AI**

* [Awesome MCP Servers](https://github.com/modelcontextprotocol/servers) ⭐ 89,986 | 🐛 516 | 🌐 TypeScript | 📅 2026-08-30
* [Awesome Machine Learning](https://github.com/josephmisiti/awesome-machine-learning) ⭐ 74,225 | 🐛 30 | 🌐 Python | 📅 2026-08-27 · [Awesome Deep Learning](https://github.com/ChristosChristofidis/awesome-deep-learning) ⭐ 28,841 | 🐛 84 | 📅 2025-05-26
* [Awesome Computer Vision](https://github.com/jbhuang0604/awesome-computer-vision) ⭐ 23,526 | 🐛 92 | 📅 2024-05-17
