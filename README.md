...
4. Pick a benchmark ([LIBERO](https://libero-project.github.io/), [SimplerEnv](https://github.com/simpler-env/SimplerEnv) ⭐ 1,163 | 🐛 35 | 🌐 Jupyter Notebook | 📅 2025-12-20, [RoboCasa](https://robocasa.ai/)) and reproduce one result before you propose anything.
...
| [PrusaSlicer](https://www.prusa3d.com/prusaslicer/) / [OrcaSlicer](https://github.com/SoftFever/OrcaSlicer) ⭐ 15,685 \| 🐛 2,683 \| 🌐 C++ \| 📅 2026-09-14 | Slicers                  | 🆓                 | Printed robot parts: print orientation determines layer-direction strength |
...
* 🔧 [Python Robotics](https://github.com/AtsushiSakai/PythonRobotics) ⭐ 30,501 | 🐛 55 | 🌐 Python | 📅 2026-09-07 🆓 — readable implementations of dozens of algorithms. **Excellent for learning.** ⭐
* 🔧 [Pinocchio](https://github.com/stack-of-tasks/pinocchio) ⭐ 3,728 | 🐛 101 | 🌐 C++ | 📅 2026-09-07 🆓 — fast rigid-body dynamics with analytical derivatives. The backbone of most modern whole-body controllers.
* 🔧 [Crocoddyl](https://github.com/loco-3d/crocoddyl) ⭐ 1,298 | 🐛 20 | 🌐 C++ | 📅 2026-09-14 🆓 — DDP-family optimal control for legged/multi-contact robots. 🔬
...
| ------------------------------------------------------------------------------------------------------------------------- | ------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [**Newton**](https://github.com/newton-physics/newton) ⭐ 5,630 \| 🐛 423 \| 🌐 Python \| 📅 2026-09-14                    | 🆓     | The new centre of gravity. Open-source, GPU-accelerated, differentiable; built on NVIDIA Warp + OpenUSD; developed by NVIDIA + Google DeepMind + Disney Research under the Linux Foundation. v1.0 GA at GTC 2026. Bundles MuJoCo-Warp and Disney's Kamino (closed-loop mechanisms) solvers, SDF collision, hydroelastic contact, and deformables. |
| [MuJoCo](https://mujoco.org/)                                                                                             | 🆓     | Contact-rich control research; CPU version remains the easiest to debug                                                                                                                                                                                                                                                                           |
| [MuJoCo Playground](https://github.com/google-deepmind/mujoco_playground) ⭐ 2,201 \| 🐛 111 \| 🌐 Python \| 📅 2026-09-09 | 🆓     | Ready-made GPU RL environments                                                                                                                                                                                                                                                                                                                    |
| [Isaac Lab](https://github.com/isaac-sim/IsaacLab) ⭐ 8,120 \| 🐛 508 \| 🌐 Python \| 📅 2026-09-14                        | 🆓     | Large-scale robot learning; v3.0 builds on Newton + PhysX                                                                                                                                                                                                                                                                                         |
| [Isaac Sim](https://developer.nvidia.com/isaac/sim)                                                                       | 🆓     | Photorealistic digital twins, synthetic data, sensor simulation                                                                                                                                                                                                                                                                                   |
| [Genesis](https://github.com/Genesis-Embodied-AI/Genesis) ⭐ 29,946 \| 🐛 125 \| 🌐 Python \| 📅 2026-09-14                | 🆓     | Fast multi-platform GPU physics; strong on generative scene creation                                                                                                                                                                                                                                                                              |
...
* 🔧 [SAM 2](https://github.com/facebookresearch/sam2) ⭐ 19,857 | 🐛 486 | 🌐 Jupyter Notebook | 📅 2026-05-30 🆓 — promptable segmentation for images and video; now a standard preprocessing block in robot perception.
* 🔧 [ORB-SLAM3](https://github.com/UZ-SLAMLab/ORB_SLAM3) ⭐ 9,064 | 🐛 571 | 🌐 C++ | 📅 2024-07-24 🆓 / [RTAB-Map](https://introlab.github.io/rtabmap/) 🆓 — visual and RGB-D SLAM.
* 🔧 [Nerfstudio](https://docs.nerf.studio/) 🆓 / [gsplat](https://github.com/nerfstudio-project/gsplat) ⭐ 5,676 | 🐛 365 | 🌐 Python | 📅 2026-09-03 🆓 — NeRF and 3D Gaussian splatting; now used for real-to-sim asset capture.
* 🔧 [FoundationPose](https://github.com/NVlabs/FoundationPose) ⭐ 3,557 | 🐛 145 | 🌐 Python | 📅 2026-04-29 🆓 — 6-DoF pose estimation for novel objects.
...
* 📄 [**Diffusion Policy: Visuomotor Policy Learning via Action Diffusion**](https://diffusion-policy.cs.columbia.edu/) — Chi et al., RSS 2023 / *IJRR* 2025. 🆓 **The foundational paper.** ⭐ [code](https://github.com/real-stanford/diffusion_policy) ⭐ 4,541 | 🐛 99 | 🌐 Python | 📅 2024-12-24 · [arXiv](https://arxiv.org/abs/2303.04137)
...
| [**OpenVLA**](https://openvla.github.io/)                                                                                        | 7B      | 🆓            | Stanford/Berkeley, 2024. \~970k Open X-Embodiment episodes; DINOv2 + SigLIP + Llama 2. The reference open VLA. [📄](https://arxiv.org/abs/2406.09246) [code](https://github.com/openvla/openvla) ⭐ 7,007 \| 🐛 115 \| 🌐 Python \| 📅 2025-03-23 |
| [OpenVLA-OFT](https://openvla-oft.github.io/)                                                                                    | 7B      | 🆓            | Optimised fine-tuning recipe; large speed/success gains over base OpenVLA                                                                                                                                                                        |
| [**π₀ / openpi**](https://github.com/Physical-Intelligence/openpi) ⭐ 13,793 \| 🐛 341 \| 🌐 Python \| 📅 2026-08-24              | \~3B    | 🆓 weights    | Physical Intelligence. Flow-matching action expert on a VLM backbone; pretrained on 10,000+ hours. Smoothest trajectories in contact-rich tasks. [📄](https://arxiv.org/abs/2410.24164)                                                          |
| [**Isaac GR00T N**](https://github.com/NVIDIA/Isaac-GR00T) ⭐ 8,060 \| 🐛 332 \| 🌐 Python \| 📅 2026-08-20                       | \~2–3B  | 🆓            | NVIDIA. Dual-system: slow VLM planner (System 2) + fast diffusion transformer controller (System 1). N1 (Mar 2025) → N1.5 → N1.6 (Dec 2025, Cosmos-2B backbone). Built for humanoids. [📄](https://arxiv.org/abs/2503.14734)                     |
...
* 🔧 [rsl\_rl](https://github.com/leggedrobotics/rsl_rl) ⭐ 2,982 | 🐛 7 | 🌐 Python | 📅 2026-09-09 🆓 — the PPO implementation behind most legged-robot papers.
...
| [SimplerEnv](https://github.com/simpler-env/SimplerEnv) ⭐ 1,163 \| 🐛 35 \| 🌐 Jupyter Notebook \| 📅 2025-12-20 🆓 | Reproducible simulated evaluation of real-robot VLAs                            |
...
* 🔧 [**LeRobot**](https://github.com/huggingface/lerobot) ⭐ 27,475 | 🐛 875 | 🌐 Python | 📅 2026-09-14 🆓 — Hugging Face's end-to-end robot learning library. `pip install`, no ROS required. Includes ACT, Diffusion Policy, VQ-BeT, π₀, SmolVLA, HIL-SERL, TD-MPC. ⭐ [📄 ICLR 2026](https://arxiv.org/abs/2602.22818)
...
| ----------------------------------------------------------------------------------------------------------- | --------- | -------------------- | ---------------------------------------------------------------------------------------------------------------------- |
| [SO-101 / SO-ARM101](https://github.com/TheRobotStudio/SO-ARM100) ⭐ 7,459 \| 🐛 85 \| 📅 2026-09-06         | €120–350  | 6-DoF arm pair       | 🆓 open hardware. Leader/follower teleoperation; the LeRobot reference platform. Kits from Hiwonder, Seeed, WowRobo. ⭐ |
| [LeKiwi](https://github.com/SIGRobotics-UIUC/LeKiwi) ⭐ 1,423 \| 🐛 12 \| 📅 2026-08-05                      | €400      | Mobile manipulator   | SO-101 on a holonomic base; open source                                                                                |
| [Koch v1.1](https://github.com/jess-moss/koch-v1-1) ⭐ 730 \| 🐛 10 \| 📅 2024-09-17                         | €250      | 5-DoF arm            | The predecessor design; still a good build                                                                             |
| [ALOHA / ALOHA 2](https://aloha-2.github.io/)                                                               | €5k–20k   | Bimanual             | The reference bimanual teleoperation setup                                                                             |
| [Open Duck Mini](https://github.com/apirrone/Open_Duck_Mini) ⭐ 4,073 \| 🐛 31 \| 🌐 Python \| 📅 2026-01-31 | €400      | Bipedal              | Approachable legged-robot learning platform                                                                            |
...
* [LeRobot](https://github.com/huggingface/lerobot) ⭐ 27,475 | 🐛 875 | 🌐 Python | 📅 2026-09-14 — very active Discord; the current invite is linked from the repo README
...
* [PythonRobotics](https://github.com/AtsushiSakai/PythonRobotics) ⭐ 30,501 | 🐛 55 | 🌐 Python | 📅 2026-09-07 — algorithms with readable code
* [robotics-coursework](https://github.com/mithi/robotics-coursework) ⭐ 5,241 | 🐛 2 | 📅 2026-08-31 — where to learn robotics online
* [Awesome LLM Robotics](https://github.com/GT-RIPL/Awesome-LLM-Robotics) ⭐ 4,463 | 🐛 11 | 📅 2026-07-17
* [Awesome ROS2](https://github.com/fkromer/awesome-ros2) ⚠️ Archived
* [Awesome Robotics](https://github.com/ahundt/awesome-robotics) ⭐ 1,486 | 🐛 8 | 📅 2024-01-10 · [Awesome Robotics Libraries](https://github.com/jslee02/awesome-robotics-libraries) ⭐ 3,045 | 🐛 23 | 🌐 Python | 📅 2026-09-14
* [Awesome Embodied AI](https://github.com/haoranD/Awesome-Embodied-AI) ⭐ 530 | 🐛 5 | 📅 2025-06-03
* [Awesome Physical AI](https://github.com/keon/awesome-physical-ai) ⭐ 419 | 🐛 17 | 📅 2026-06-24 — VLA, world models, embodied AI, robot foundation models
* [Awesome VLA](https://github.com/KwanWaiPang/Awesome-VLA) ⭐ 101 | 🐛 2 | 📅 2026-02-03 — actively maintained VLA paper tracker

**Engineering & embedded**

* [Awesome C++](https://github.com/fffaraz/awesome-cpp) ⭐ 73,281 | 🐛 311 | 📅 2026-09-05 · [Awesome Python](https://github.com/vinta/awesome-python) ⭐ 320,543 | 🐛 18 | 🌐 Python | 📅 2026-09-13
* [Awesome Embedded](https://github.com/nhivp/Awesome-Embedded) ⭐ 9,111 | 🐛 4 | 📅 2026-09-06 · [Awesome Embedded Rust](https://github.com/rust-embedded/awesome-embedded-rust) ⭐ 8,088 | 🐛 16 | 📅 2026-09-11
* [Awesome Electronics](https://github.com/kitspace/awesome-electronics) ⭐ 8,116 | 🐛 33 | 📅 2026-09-14
* [Awesome Embedded and IoT Security](https://github.com/fkie-cad/awesome-embedded-and-iot-security) ⭐ 2,445 | 🐛 2 | 📅 2023-10-17
...
* [Awesome MCP Servers](https://github.com/modelcontextprotocol/servers) ⭐ 90,310 | 🐛 521 | 🌐 TypeScript | 📅 2026-09-03
* [Awesome Machine Learning](https://github.com/josephmisiti/awesome-machine-learning) ⭐ 74,327 | 🐛 29 | 🌐 Python | 📅 2026-09-12 · [Awesome Deep Learning](https://github.com/ChristosChristofidis/awesome-deep-learning) ⭐ 28,910 | 🐛 85 | 📅 2025-05-26
